...
//        }
 ...
 //           colorBtn1.setImage(UIImage(systemName: "checkmark"), for: .normal)
            colorBtn1.setImage(UIImage(contentsOfFile: "checkmark"), for: .normal)
    ...
    @IBAction func colorBtn2Clicked(_ sender: Any) {
        if #available(iOS 13.0, *) {
            colorBtn2.setImage(UIImage(contentsOfFile: "checkmark"), for: .normal)
        } else {
            // Fallback on earlier versions
        }
    ...
    @IBAction func colorBtn3Clicked(_ sender: Any) {
        if #available(iOS 13.0, *) {
            colorBtn3.setImage(UIImage(contentsOfFile: "checkmark"), for: .normal)
        } else {
            // Fallback on earlier versions
        }
        colorBtn2.setImage(nil, for: .normal)
    ...
    @IBAction func colorBtn4Clicked(_ sender: Any) {
        if #available(iOS 13.0, *) {
            colorBtn4.setImage(UIImage(contentsOfFile: "checkmark"), for: .normal)
        } else {
            // Fallback on earlier versions
        }
        colorBtn2.setImage(nil, for: .normal)
    ...
    @IBAction func colorBtn5Clicked(_ sender: Any) {
        if #available(iOS 13.0, *) {
            colorBtn5.setImage(UIImage(contentsOfFile: "checkmark"), for: .normal)
        } else {
            // Fallback on earlier versions
        }
        colorBtn2.setImage(nil, for: .normal)
    ...
    @IBAction func colorBtn6Clicked(_ sender: Any) {
        if #available(iOS 13.0, *) {
            coloBtn6.setImage(UIImage(contentsOfFile: "checkmark"), for: .normal)
        } else {
            // Fallback on earlier versions
        }
        colorBtn2.setImage(nil, for: .normal)
